...
public class ItemController {
    ...
    // 이름 기반 검색
    @GetMapping
    @Operation(summary = "이름으로 아이템 검색", description = "주어진 키워드에 맞는 아이템을 검색합니다.")
    ...
    @Operation(summary = "설명으로 아이템 검색", description = "주어진 설명에 맞는 아이템을 검색합니다.")
    ...
    @PostMapping
    @Operation(summary = "아이템 생성", description = "새로운 아이템을 등록합니다.")
    ...
    // 업데이트
    @PutMapping("/{id}")
    @Operation(summary = "아이템 업데이트", description = "주어진 ID에 해당하는 아이템을 업데이트합니다.")
    ...
    // 삭제
    @DeleteMapping("/{id}")
    @Operation(summary = "아이템 삭제", description = "주어진 ID에 해당하는 아이템을 삭제합니다.")
    ...
    @Operation(summary = "가격 범위로 아이템 조회", description = "주어진 가격 범위에 해당하는 아이템을 검색합니다.")
